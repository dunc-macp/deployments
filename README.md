...
```
cd existing_repo
git remote add origin https://gitlab.com/nimbus4914226/deployments.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/nimbus4914226/deployments/-/settings/integrations)
